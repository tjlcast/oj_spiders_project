...
def prepare_a_test(inf, pro):
    ...
    multiple_files = []
    multiple_files.append(('data_in', ("testProblem_01.input", open(os.path.abspath(".") + '/tmp/testProblem/testProblem_01.input', 'rb'), 'application/octet-stream')))
    multiple_files.append(('data_out', ("testProblem_01.output", open(os.path.abspath(".") + '/tmp/testProblem/testProblem_01.output', 'rb'),'application/octet-stream')))
